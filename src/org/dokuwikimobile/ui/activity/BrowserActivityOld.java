...
import org.dokuwikimobile.ui.dialog.LoginDialog.LoginDialogFinished.FinishState;
...
public class BrowserActivityOld extends Activity implements ScrollListener, 
...
//		manager.getPage(this, url.id);
	...
	private String getPageInfoMessage(PageOld page) {
		if(page == null)
			return "";
	...
	public void onPageLoaded(PageOld page) {
